...
export default function AdoptionPage(){
    ...
    let formStyles = "";
    if(formOpen){
        formStyles = "h-screen overflow-hidden";
    }
    

    return(
        <main className={formStyles}>
            ...
            <div className="absolute top-5 right-5 rounded-full w-8 h-8 overflow-hidden z-0">
                <button className="bg-blue-700 text-white text-3xl w-full h-full leading-none cursor-pointer"
                type="button" onClick={openForm}>+</button>
            </div>
